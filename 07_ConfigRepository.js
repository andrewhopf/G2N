...
class ConfigRepository {
  ...
  constructor(logger) {
    ...
    this._defaults = {
      ...
      attachmentHashPropertyName: 'G2N Attachment Hash',
    ...
    this._keys = {
      ...
      filesPropertyType: 'G2N_FILES_PROPERTY_TYPE',
      attachmentHashPropertyName: 'G2N_ATTACHMENT_HASH_PROPERTY_NAME',
  ...
  getAll() {
    try {
      ...
      return {
        ...
        filesPropertyType: props[this._keys.filesPropertyType] || this._defaults.filesPropertyType,
        attachmentHashPropertyName: props[this._keys.attachmentHashPropertyName] || this._defaults.attachmentHashPropertyName,
